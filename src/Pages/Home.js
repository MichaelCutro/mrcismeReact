    ...
    if (typeof window.ethereum !== "undefined") {
      ...
      function openOpe() {
        var ask = window.confirm(
          "Ope, this page is token gated. You'll need a wallet and some ether to view it!"
        );
        if (ask) {
      ...
      <div>
        ...
        <div className="flex flex-row items-center justify-center">
          ...
          <a href="https://etherscan.io/nft/0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85/67630336915142393376093869579614968646233538377798945534444013812028772696033">
            <button className="px-4 hover:scale-150">Ξ</button>
          </a>

          <button
            onClick={connectedButtonOnClick}
            className="px-4 hover:scale-150"
          >
            ⛩️
          </button>
