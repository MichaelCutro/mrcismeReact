...
const Mike = () => {
  ...
  return (
    <h1 className="text-black text-3xl font-bold relative inline-block">
      <span
        id="before-te1"
        className="absolute top-0 left-0.5 w-full h-full bg-transparent text-shadow-2xl clip-rect"
        style={{
          textShadow: "-2px 0 #01FEFE",
